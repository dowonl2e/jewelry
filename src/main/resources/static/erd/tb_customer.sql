CREATE TABLE tb_customer (
  ...
  constractor_nm varchar(80) NOT NULL COMMENT '이름',
  constractor_gen varchar(30) COMMENT '성별',
  constractor_cel varchar(50) COMMENT '연락처',
  constractor_birth varchar(10) COMMENT '생일', 
  constractor_lunar varchar(10) NOT NULL DEFAULT 'N' COMMENT '음력여부', 
  constractor_email varchar(30) COMMENT '이메일',
